...
namespace Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Tests\Menu;



use Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Tests\ContainerAwareUnit;
use Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Menu\MenuBuilder;
...
class MenuBuilderTest extends ContainerAwareUnit
{
    ...
    {
        $document = m::mock('Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Entity\Document');
        $document->shouldReceive('getName')
        ->andReturn('doc');
        
        $event = m::mock('Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Entity\Event');
        $event->shouldReceive('getShortEvent')->andReturn('event');
        $event->shouldReceive('getType')->andReturn('TYPE');
        
        $project = m::mock('Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Entity\Project');
        $project->shouldReceive(array('getDocuments' => array($document), 'getEvents' => array($event), 'getName' => 'project'));
        
        $projectDao = m::mock('Atos\Worldline\Fm\Integration\Ucs\EventFlowAnalyser\Dao\ProjectDao');
