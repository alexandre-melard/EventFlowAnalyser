...
class Project implements Entity, VisitorHost
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Mylen\EventFlowAnalyser\Entity\Document", mappedBy="project")
     */
    private $documents;

    /**
     * @ORM\OneToMany(targetEntity="Mylen\EventFlowAnalyser\Entity\Event", mappedBy="project")
     */
    private $events;
