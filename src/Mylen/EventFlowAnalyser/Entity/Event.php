...
class Event  implements VisitorHost, Entity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mylen\EventFlowAnalyser\Entity\Project", inversedBy="events")
     */
    private $project;
    
    /**
     * @ORM\ManyToMany(targetEntity="Mylen\EventFlowAnalyser\Entity\EventIn")
     */
    private $parents;
    
    /**
     * @ORM\ManyToMany(targetEntity="Mylen\EventFlowAnalyser\Entity\EventOut")
     */
    private $children;
