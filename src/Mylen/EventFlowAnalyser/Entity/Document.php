...
class Document implements VisitorHost, Entity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mylen\EventFlowAnalyser\Entity\Project", inversedBy="documents")
     */
    private $project;

    /**
     * @ORM\OneToOne(targetEntity="Mylen\EventFlowAnalyser\Entity\Parser", inversedBy="document")
     */
    private $parser;
